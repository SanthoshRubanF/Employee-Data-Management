...
# Entries Frame
entries_frame = Frame(App, bg="#535c68")
...
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=15, font=("Calibri", 16, "bold"),
                fg="white", bg="#11e302", bd=0).grid(row=0, column=0, padx=10)
btnEdit = Button(btn_frame, command=update_employee, text="Update Details", width=15, font=("Calibri", 16, "bold"),
                 fg="white", bg="#f0bd05", bd=0).grid(row=0, column=1, padx=10)
btnDelete = Button(btn_frame, command=delete_employee, text="Delete Details", width=15, font=("Calibri", 16, "bold"),
                   fg="white", bg="#fc0522", bd=0).grid(row=0, column=2, padx=10)
btnClear = (Button(btn_frame, command=clearAll, text="Clear All Details", width=15, font=("Calibri", 16, "bold"),
                   fg="white", bg="#f07a05", bd=0).grid(row=0, column=3, padx=10))

# Table Frame
tree_frame = Frame(App, bg="#ecf0f1")
tree_frame.place(x=0, y=480, width=1980, height=520)
style = ttk.Style()
style.configure("mystyle.Treeview", fornt=("Arial", 18), rowheght=50)   # Modify the font of the body
